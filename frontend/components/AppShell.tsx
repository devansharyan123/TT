  ...
  return (
    <div className="min-h-screen md:flex">
      ...
      <div className="flex-1 md:ml-64">
        <header className="sticky top-0 z-40 px-3 sm:px-6 pt-4">
          <div className="glass rounded-2xl p-2 sm:p-2.5 flex items-center justify-between gap-2">
              ...
              {topLinks.map(({ href, label, icon: Icon }) => {
                ...
                return (
                  <Link key={href} href={href} className="shrink-0">
                    <div
                      className="px-2.5 sm:px-3 py-2 rounded-xl text-xs sm:text-sm font-semibold flex items-center gap-1.5 sm:gap-2"
                      style={{
